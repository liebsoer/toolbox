...
describe('#WorkflowTest', () => {
  ...
  it('generate feeback with string arg', () => {
    const expectedObj =
      '{"items":[{"arg":"arg","valid":"NO","title":"title"}]}';
    const item = new Item({
      title: 'title',
      arg: 'arg',
    });
  ...
  it('generate feeback with variables in arg', () => {
    const expectedObj =
      '{"items":[{"arg":"{\\"alfredworkflow\\":{\\"arg\\":\\"arg\\",\\"variables\\":{\\"key\\":\\"value\\"}}}","valid":"NO","title":"title"}]}';
    const item = new Item({
      title: 'title',
      arg: {
        arg: 'arg',
  ...
  it('generate 2 feeback', () => {
    const expectedObj =
      '{"items":[{"uid":"1","valid":"YES","title":"title 1.1"},{"uid":"2","valid":"NO","title":"title 1.2"}]}';
    const item = new Item({
      title: 'title 1.1',
      valid: true,
      uid: '1',
  ...
  it('generate error feeback', () => {
    const expectedObj =
      '{"items":[{"valid":"NO","title":"wf error","icon":{"path":"/System/Library/CoreServices/CoreTypes.bundle/Contents/Resources/AlertStopIcon.icns"}}]}';
  ...
  it('generate warning feeback', () => {
    const expectedObj =
      '{"items":[{"valid":"NO","title":"wf warning","icon":{"path":"/System/Library/CoreServices/CoreTypes.bundle/Contents/Resources/AlertCautionBadgeIcon.icns"}}]}';
  ...
  it('generate info feeback', () => {
    const expectedObj =
      '{"items":[{"valid":"NO","title":"wf info","icon":{"path":"/System/Library/CoreServices/CoreTypes.bundle/Contents/Resources/ToolbarInfo.icns"}}]}';
...
describe('#ActionHandlerTest', () => {
  ...
  it('test sub action handler', () => {
    ...
    let data2 = '';
    let data3 = '';
    actionHandler.onMenuItemSelected(
      'action',
      (query, selectedItemTitle, selectedItemData) => {
